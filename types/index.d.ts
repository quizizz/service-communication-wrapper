...
export class HttpCommunication {
     ...
     */
    static getRequestContext(req: any, customContextValue?: Record<string, unknown>): { traceId: string, spanId: string, userId: string, ab: string, reqStartTime: number, path: string };
